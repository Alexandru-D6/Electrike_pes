...
class HappyLungsAdpt {
  ...
  final urlorgWeb = 'https://obscure-lake-86305.herokuapp.com/http://ec2-18-208-246-30.compute-1.amazonaws.com:7000/v1/contamination/';
  ...
  Future<Map<double, GeoCoord>> getEcoPoints(GeoCoord geoCoord) async{
    ...
    if (kIsWeb) urlc = urlorgWeb+ geoCoord.latitude.toString() + '/' + geoCoord.longitude.toString() + '/' + radius.toString();
