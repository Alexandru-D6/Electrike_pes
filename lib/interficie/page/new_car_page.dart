  ...
  Widget buildSubmit(BuildContext context) => ButtonWidget(//todo: collect info car and submit to ctrlPres to domain
    ...
    onClicked: () {
      ...
      if (form.validate()) {
        ...
        List<String> car = ['assets/images/brandCars'+ selectedBrandCar! +'.png', selectedNameCar!, selectedBrandCar!, selectedModelCar!, selectedBatteryCar!, selectedEffciencyCar!];
